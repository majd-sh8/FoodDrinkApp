    ...
    private void deleteMvoie() {
        class DeleteMovie extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                Toast.makeText(MovieDetailActivity.this, "delete", Toast.LENGTH_SHORT).show();
        ...
        class SaveMovie extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                DatabaseClient.getInstance(getApplication()).getAppDatabase()
                        .movieDao()
                        .insert(m);
                Log.d("poster", m.getPoster_path());
                Log.d("back", m.getBackdrop_path());
            ...
            @Override
            protected void onPostExecute(Void aVoid) {
                Toast.makeText(MovieDetailActivity.this, "Save", Toast.LENGTH_SHORT).show();
                super.onPostExecute(aVoid);
            }
        }
